...
const iniciarOuPausarBtImg = document.querySelector('#start-pause')
const iniciarOuPausarBtImgIcone = document.querySelector(".app__card-primary-butto-icon")
...
function iniciarOuPausar() {
    ...
    iniciarOuPausarBtImgIcone.setAttribute('src', `/imagens/pause.png`)
}

function zerar() {
    clearInterval(intervaloID)
    iniciarOuPausarBt.textContent = "Começar"
    iniciarOuPausarBtImgIcone.setAttribute('src', `/imagens/play_arrow.png`)
    intervaloID = null
}
